...
export const clientMap: Record[] = [
  ...
  { trans: 'shipping_address1', value: 'client.shipping_address1', map: 'client' },
  { trans: 'shipping_address2', value: 'client.shipping_address2', map: 'client' },
  { trans: 'shipping_city', value: 'client.shipping_city', map: 'client' },
  { trans: 'shipping_state', value: 'client.shipping_state', map: 'client' },
  { trans: 'shipping_postal_code', value: 'client.shipping_postal_code', map: 'client' },
  { trans: 'shipping_country', value: 'client.shipping_country_id', map: 'client' },
