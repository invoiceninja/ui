...
export function AURegions() {
    ...
    const regions: Array<[string, TaxSetting]> = Object.entries(companyChanges.tax_data.regions.AU.subregions);
                ...
                <div className="grid grid-cols-5 gap-4">
                    <div className="col-span-4">
                        <SelectField
                            ...
                            onValueChange={(value) =>
                                handleChangeAndUpdateView('tax_data.regions.AU.tax_all_subregions', value === "true")
                            }
                        >
            ...
            {isOpen && (
                ...
                regions?.map((value: [string, TaxSetting], index) => (
                    ...
                    <div key={index} className="border py-4 sm:py-3 sm:grid sm:grid-cols-3 sm:gap-10 flex flex-col lg:flex-row undefined px-5 sm:px-6 lg:items-center">
                        ...
                        <div className="flex col-span-1 items-center justify-start pl-5" onClick={() => divClickIntercept(`tax_data.regions.AU.subregions.${value[0]}.apply_tax`)}>
                            <Checkbox
                        ...
                        <div onClick={() => divClickIntercept(`tax_data.regions.AU.subregions.${value[0]}.apply_tax`)}>
