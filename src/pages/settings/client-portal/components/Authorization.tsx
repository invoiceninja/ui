...
export function Authorization() {
  ...
  return (
    <Card title={t('authorization')}>
      ...
      >
        <Toggle
          checked={company?.settings.enable_client_portal_password}
          onValueChange={(value) =>
      ...
      >
        <Toggle
          checked={company?.settings.show_accept_invoice_terms}
          onValueChange={(value) =>
      ...
      >
        <Toggle
          checked={company?.settings.show_accept_quote_terms}
          onValueChange={(value) =>
      ...
      >
        <Toggle
          checked={company?.settings.require_invoice_signature}
          onValueChange={(value) =>
      ...
      >
        <Toggle
          checked={company?.settings.require_quote_signature}
          onValueChange={(value) =>
      ...
      >
        <Toggle
          checked={company?.settings.require_purchase_order_signature}
          onValueChange={(value) =>
      ...
      >
        <Toggle
          checked={company?.settings.signature_on_pdf}
          onValueChange={(value) =>
