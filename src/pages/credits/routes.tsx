    ...
    <Route
      ...
      element={
        <Guard
          guards={[
            enabled(ModuleBitmask.Credits),
            or(permission('edit_credit'), permission('view_credit'), assigned('/api/v1/credits/:id')),
          ]}
          component={<Edit />}
        />
      }
    ...
    <Route
      ...
      element={
        <Guard
          guards={[
            enabled(ModuleBitmask.Credits),
            or(permission('view_credit'), permission('edit_credit'),  assigned('/api/v1/credits/:id')),
          ]}
          component={<Pdf />}
        />
      }
