 ...
 */
 ...
 export function PastDueInvoices() {
     ...
     const { data, isLoading, isError } = useQuery('/api/v1/invoices?include=client&overdue=true&per_page=50&page=1', () =>
         request('GET', endpoint('/api/v1/invoices?include=client&overdue=true&per_page=50&page=1'))
     );
             ...
             <div className="bg-white shadow sm:rounded-lg sm:overflow-hidden">
                 <div className="divide-y divide-gray-200">
                     <div className="px-2 py-2 sm:px-6">
                         <h2 id="notes-title" className="text-lg font-medium text-gray-900">{t('past_due_invoices')}</h2>
                     </div>
                     <div className="">
