    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className={`inline-block align-bottom bg-white rounded px-4 pt-5 pb-4 text-left ${props.overFlow?' ':' overflow-hidden'} shadow-xl transform transition-all sm:my-8 sm:align-middle w-full sm:max-w-sm sm:p-6`}>
              <div>
