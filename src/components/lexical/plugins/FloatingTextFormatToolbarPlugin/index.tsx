...
function TextFormatFloatingToolbar({
  ...
  return (
    <div
      ...
      className={classNames('floating-text-format-popup', {
        'floating-text-format-popup-light': !reactSettings.dark_mode,
        'floating-text-format-popup-dark': reactSettings.dark_mode,
      })}
    >
      {editor.isEditable() && (
        <>
