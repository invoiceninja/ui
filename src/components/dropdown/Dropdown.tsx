      ...
      >
        <LabelButton
          ...
          className={classNames(
            `flex items-center space-x-2 justify-center rounded text-sm disabled:cursor-not-allowed disabled:opacity-75 ${props.className}`,
            {
              'hover:bg-white hover:border-gray-300': !props.cardActions,
              'hover:opacity-90': props.cardActions,
              'border px-4 py-2': !props.labelElement,
            }
          )}
          style={{
