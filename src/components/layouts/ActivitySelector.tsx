...
export function useActivityLabels(): Record<ActivityType, string> {
  ...
  return {
    ...
    [ACTIVITY_TYPES.VERIFACTU_INVOICE_SENT]: t(
      'verifactu_invoice_send_success'
    ),
    [ACTIVITY_TYPES.VERIFACTU_INVOICE_SENT_FAILURE]: t(
      'verifactu_invoice_sent_failure'
    ),
    [ACTIVITY_TYPES.VERIFACTU_CANCELLATION_SENT]: t(
      'verifactu_cancellation_send_success'
    ),
    [ACTIVITY_TYPES.VERIFACTU_CANCELLATION_SENT_FAILURE]: t(
      'verifactu_cancellation_send_failure'
    ),
